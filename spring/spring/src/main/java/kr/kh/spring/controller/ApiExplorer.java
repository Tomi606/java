...
public class ApiExplorer {
    public static void main(String[] args) throws IOException {
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=VAIHv5B3toI1498zg0NZ0lmmB74W8U68%2BAkNlUEnHLYZpa1%2FtNaD9IwAhVoweuKnfqvhdS9zEUMFjOOvFILDDg%3D%3D"); /*Service Key*/
        ...
        urlBuilder.append("&" + URLEncoder.encode("searchDate","UTF-8") + "=" + URLEncoder.encode("2024-04-28", "UTF-8")); /*통보시간 검색(조회 날짜 입력이 없을 경우 한달동안 예보통보 발령 날짜의 리스트 정보를 확인)*/
