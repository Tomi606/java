...
public class StringEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(str.indexOf("cdf"));	//-1
		//있으면 있다, 없으면 없다를 반환(boolean)
		...
		//부분 문자열을 반환
		String str3 = str.substring(1,3);	//1~3의 "앞 번지"까지 출력
		//기존 문자열은 안 바뀜
		System.out.println(str);
		...
		String []fruitArray = fruits.split(",");//콤마를 기준으로 추출
