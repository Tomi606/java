...
public class HomeworkEx3_1 {
	...
	static class Member {
		...
		//equals : 아이디 비번이 주어지면 내 정보와 같은지 다른지 알려주는 메서드(객체마다 다르게 비교해야하기 때문에 static 이 안붙음,나와 비교해야되기 때문)
		...
		//생성자 : 기본생성자, 아이디와 비번과 이메일이 필요한 생성자, 아이디와 비번이 필요한 생성자
		public Member() {}
